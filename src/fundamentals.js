...
// function to check whether AssignmentGroup does belong to its course 
...
function getLearnerData(CourseInfo, AssignmentGroup, LearnerSubmissions) {
  ...
  // looping through learnersSubmisions to create learnersData array and calculate average
    ...
    for (const learnerID in learnerData) {
      ...
      //To display assignment score with assignment id
        let result1
      ...
      //combining result  to display as per output
        const learnerResult = {
  ...
  // Calling getLearerData function with parameters for data calculations
